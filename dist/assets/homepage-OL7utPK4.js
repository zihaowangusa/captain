import { u as useNavigate, r as reactExports, j as jsxRuntimeExports } from "./index-CnDKNMMk.js";
import { L as Logo } from "./logo-DRY5X6k7.js";
import { L as Layout, I as Image, A as Avatar, R as RefIcon } from "./UserOutlined-DLyZPVX0.js";
import { F as Flex, T as Typography } from "./index-htyRGXs6.js";
import { M as Menu } from "./addEventListener-L_Xx08a1.js";
import { P as Popover } from "./index-CQurjkRV.js";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Layout, { className: styles.layout, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Header, { className: styles.header, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Flex, { justify: "space-between", align: "top", style: { height: "100%" }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Flex, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Image, { src: Logo, alt: "Captain Dental", width: 150, preview: false }),
        ...
        Popover,
        {
          content: /* @__PURE__ */ jsxRuntimeExports.jsxs(Flex, { vertical: true, style: { minWidth: 200, maxWidth: 400 }, gap: 10, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(Flex, { align: "center", gap: 5, children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Avatar, { src: "https://api.dicebear.com/7.x/miniavs/svg?seed=5" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(Flex, { vertical: true, children: [
                (user == null ? void 0 : user.name) && /* @__PURE__ */ jsxRuntimeExports.jsx(Text, { style: { fontSize: 16, textWrap: "nowrap" }, children: `Name: ${(user == null ? void 0 : user.name) || ""}` }),
                (user == null ? void 0 : user.email) && /* @__PURE__ */ jsxRuntimeExports.jsx(Text, { style: { fontSize: 16, textWrap: "nowrap" }, children: `Email: ${(user == null ? void 0 : user.email) || ""}` })
              ] })
            ] }),
          ...
          title: "",
          placement: "bottom",
          children: /* @__PURE__ */ jsxRuntimeExports.jsx(Avatar, { style: { backgroundColor: "#87d068", marginTop: 18 }, icon: /* @__PURE__ */ jsxRuntimeExports.jsx(RefIcon, {}) })
        }
      )
    ] }) }),
