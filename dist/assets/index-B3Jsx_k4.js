import { I as Icon, z as _extends, F as _slicedToArray, _ as _typeof, b as classNames, D as _defineProperty, au as CSSMotionList, L as _objectWithoutProperties, E as _objectSpread2, a as _toConsumableArray, g as genStyleHooks, n as merge$1, r as resetComponent, C as ConfigContext, R as RefIcon$3, O as RefIcon$5, x as devUseWarning, ax as useSafeState, B as Button, ay as convertLegacyProps, a1 as canUseDom, p as useEvent, az as getConfirmLocale, aA as DisabledContextProvider, s as genSubStyleComponent, as as clearFix, u as unit, a0 as ConfigProvider, v as useToken, Z as globalConfig, aB as unmount, $ as render, an as localeValues, o as omit } from "./button-CRpLj63U.js";
import { r as reactExports, R as React, a as reactDomExports } from "./index-B-eg_Oe6.js";
import { R as RefIcon$2, a as RefIcon$4 } from "./ExclamationCircleFilled-CP3D0USy.js";
import { p as pickAttrs, B as KeyCode, K as Keyframe, C as CONTAINER_MAX_OFFSET, c as useCSSVarCls, b as RefIcon$6, z as useLocale, d as useZIndex, M as ContextIsolator, N as zIndexContext, G as getTransitionName, f as useMergedState } from "./index-CW6vE3_Z.js";
import { u as useStyle$2, D as DialogWrap, p as prepareToken, a as prepareComponentToken$2, b as Panel, c as PurePanel$4, d as getRenderPropValue, P as Popover } from "./index-zCWgOtpQ.js";
import { q as useClosable, r as pickClosable, J as withPureRenderTheme } from "./index-Bt70kxsH.js";
import { S as Skeleton } from "./index-yrKC9Mq8.js";
...
const useStyle$1 = genStyleHooks("Message", (token) => {
...
const TypeIcon = {
  ...
  warning: /* @__PURE__ */ reactExports.createElement(RefIcon$4, null),
  loading: /* @__PURE__ */ reactExports.createElement(RefIcon$5, null)
};
...
const PurePanel$3 = (props) => {
  const {
    ...
    icon,
    content
  } = props, restProps = __rest$7(props, ["prefixCls", "className", "type", "icon", "content"]);
  const {
    getPrefixCls
  ...
  const wrapAPI = reactExports.useMemo(() => {
    ...
    const open2 = (config) => {
      ...
      const {
        ...
        style,
        onClose
      } = config, restConfig = __rest$6(config, ["content", "icon", "type", "key", "className", "style", "onClose"]);
      let mergedKey = key;
...
function renderCloseIcon(prefixCls, closeIcon) {
  return /* @__PURE__ */ React.createElement("span", {
    className: `${prefixCls}-close-x`
  }, closeIcon || /* @__PURE__ */ React.createElement(RefIcon$6, {
    className: `${prefixCls}-close-icon`
  }));
}
const Footer = (props) => {
...
const Modal$1 = (props) => {
  ...
  const {
    ...
    children,
    loading
  } = props, restProps = __rest$5(props, ["prefixCls", "className", "rootClassName", "open", "wrapClassName", "centered", "getContainer", "focusTriggerAfterClose", "style", "visible", "width", "footer", "classNames", "styles", "children", "loading"]);
  ...
  const [mergedClosable, mergedCloseIcon] = useClosable(pickClosable(props), pickClosable(modalContext), {
    closable: true,
    closeIcon: /* @__PURE__ */ reactExports.createElement(RefIcon$6, {
      className: `${prefixCls}-close-icon`
    }),
...
const Overlay = (props) => {
  const {
    ...
    okText,
    okType = "primary",
    icon = /* @__PURE__ */ reactExports.createElement(RefIcon$4, null),
    showCancel = true,
    close,
    onConfirm,
    onCancel,
...
const InternalPopconfirm = /* @__PURE__ */ reactExports.forwardRef((props, ref) => {
  ...
  const {
    ...
    onOpenChange,
    onVisibleChange
  } = props, restProps = __rest(props, ["prefixCls", "placement", "trigger", "okType", "icon", "children", "overlayClassName", "onOpenChange", "onVisibleChange"]);
  const {
    getPrefixCls
  } = reactExports.useContext(ConfigContext);
...
var RefIcon = /* @__PURE__ */ reactExports.forwardRef(DeleteOutlined);
...
axios.default = axios;
const API_PREFIX = ["localhost", "127.0.0.1"].includes(location.hostname) ? "http://127.0.0.1:9699/api" : `http://${location.hostname}:9699/api`;
export {
  API_PREFIX as A,
  ...
  Popconfirm as P,
  RefIcon as R,
  WatermarkContext as W,
  axios as a,
  NotificationProvider as b,
  AppConfigContext as c,
  useMessage as d,
  useModal as e,
  AppContext$1 as f,
  usePanelRef as g,
