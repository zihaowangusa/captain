import { b as classNames, g as genStyleHooks, n as merge, u as unit, C as ConfigContext, o as omit, I as Icon, z as _extends, a as _toConsumableArray, w as wrapperRaf, e as composeRef, aG as supportRef, L as _objectWithoutProperties, F as _slicedToArray, D as _defineProperty, E as _objectSpread2, H as useLayoutUpdateEffect, _ as _typeof, p as useEvent, Y as useComposeRef, d as CSSMotion, y as toArray, r as resetComponent, t as textEllipsis, q as genFocusStyle, S as useSize, as as clearFix, Q as useCompactItemContext, c as cloneElement, B as Button } from "./button-CRpLj63U.js";
import { r as reactExports, R as React } from "./index-B-eg_Oe6.js";
import { K as Keyframe, B as KeyCode, e as Trigger, Q as ExportMenu, S as MenuItem, a as RefResizeObserver, aa as isMobile, f as useMergedState, G as getTransitionName, y as initSlideMotion, c as useCSSVarCls, b as RefIcon$5, $ as RefIcon$6, aE as useResponsiveObserver, a8 as responsiveArray, aJ as useStyle$4, j as FormItemInputContext, q as initInputToken, k as initComponentToken, aK as Input$1, p as pickAttrs, H as getMergedStatus, aL as useRemovePasswordTimeout, a1 as RefIcon$7, aM as TextArea } from "./index-CW6vE3_Z.js";
const Element = (props) => {
  const {
    prefixCls,
    className,
...
const Tabs = (props) => {
  ...
  if (type === "editable-card") {
    editable = {
      ...
      addIcon: (addIcon !== null && addIcon !== void 0 ? addIcon : tabs === null || tabs === void 0 ? void 0 : tabs.addIcon) || /* @__PURE__ */ reactExports.createElement(RefIcon$1, null),
